...
class TestTradingEngineProperties:
    ...
    def test_account_property_with_gateway(self, trading_engine, mock_gateway):
        ...
        mock_account.md_connected = False
        mock_account.td_connected = False
        mock_gateway.get_account.return_value = mock_account
        mock_gateway.md_connected = False
        mock_gateway.td_connected = False

        result = trading_engine.account
        assert result.md_connected is False
        assert result.td_connected is False
