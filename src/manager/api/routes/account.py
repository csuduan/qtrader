    ...
    try:
        ...
        return success_response(
            data=AccountRes(
                ...
                pre_balance=float(account_data.pre_balance or 0),     
                static_balance=float(account_data.static_balance or 0),
                ...
                md_connected=account_data.md_connected,
                td_connected=account_data.td_connected,
        ...
        for account_info in accounts:
            ...
            accounts_list.append(
                AccountRes(
                    ...
                    pre_balance=float(account_info.pre_balance or 0),
                    static_balance=float(account_info.static_balance or 0),
                    ...
                    md_connected=account_info.md_connected,
                    td_connected=account_info.td_connected,
